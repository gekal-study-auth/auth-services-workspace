...
const coreProtocols: Protocol[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        to: "user",
        label: "ログインと同意",
        detail: "Authorization Serverが本人を認証し、要求された権限への同意を確認します。",
      ...
      },
      {
        ...
        to: "client",
        label: "認可コードを返却",
        detail: "短時間だけ有効な一回限りのコードを登録済みredirect_uriへ返します。",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        to: "user",
        label: "ログインと同意",
        detail: "ユーザーを認証し、要求scopeへの同意を取得します。",
      ...
      },
      {
        ...
        to: "client",
        label: "認可コードを返却",
        detail: "challengeと関連付けた認可コードを返します。",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        to: "user",
        label: "本人認証と同意",
        detail: "OpenID Providerが本人を認証し、渡すclaimsへの同意を確認します。",
      ...
      },
      {
        ...
        to: "client",
        label: "認可コードを返却",
        detail: "認証結果と紐付いた短時間有効なコードを返します。",
