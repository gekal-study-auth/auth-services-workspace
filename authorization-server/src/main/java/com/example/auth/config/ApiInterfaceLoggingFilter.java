...
public class ApiInterfaceLoggingFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      log.info(
          "event=api_interface service=authorization-server request_id={} method={} path={} status={} duration_ms={} request_body={} response_body={}",
          requestId,
          request.getMethod(),
  ...
  private void logMetadata(
    ...
    try {
      ...
      long durationMs = (System.nanoTime() - startedAt) / 1_000_000;
      log.info(
          "event=api_interface service=authorization-server request_id={} method={} path={} status={} duration_ms={}",
          requestId,
          request.getMethod(),
          request.getRequestURI(),
          response.getStatus(),
