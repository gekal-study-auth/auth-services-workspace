...
public class ControllerMethodLoggingAspect {
  ...
  @Around(
      "within(com.example.auth..*) && @within(org.springframework.web.bind.annotation.RestController)")
  public Object logControllerMethod(ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    try {
      ...
      log.info(
          "event=controller_method service=authorization-server request_id={} controller={} method={} duration_ms={} arguments={} return={}",
      ...
      log.warn(
          "event=controller_method_error service=authorization-server request_id={} controller={} method={} duration_ms={} arguments={} exception={} message={}",
          MDC.get(RequestCorrelationFilter.REQUEST_ID_MDC_KEY),
          controller,
          method,
          elapsedMillis(startedAt),
